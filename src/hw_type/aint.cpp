...
void aint_t::operator op(const aint_t & other) const { \
	as_cpp_int(_M) op as_cpp_int(other._M);            \
}                                                      \
void aint_t::operator op(uint64_t other) const {       \
	as_cpp_int(_M) op other;                           \
}                                                      \
void aint_t::operator op(int64_t other) const {        \
	as_cpp_int(_M) op other;                           \
}                                                      \
void aint_t::operator op(int other) const {            \
	as_cpp_int(_M) op other;                           \
}                                                      \
void aint_t::operator op(unsigned other) const {       \
	as_cpp_int(_M) op other;                           \
}
...
void aint_t::operator <<=(uint64_t other) const {
	as_cpp_int(_M) <<= other;
}
void aint_t::operator >>=(uint64_t other) const {
	as_cpp_int(_M) >>= other;
